...
let%expect_test "Manga viewer" =
  ...
  [%expect
    ...
    │ ............................./ad9bc794465f484c0e0a83d2e1203ec9/1-2b06f7cba184a57f4ad9cc.............................   │
    │ .............................b976d8d8197d979a5bcf15fa79c0f8003a17713c6c.jpg)(row 3)(col.............................   │
    │ .............................umn 1)(dimensions((height 25)(width 116)))(scale true))................................   │
    │ ....................................................................................................................   │
    │ ....................................................................................................................   │
    │ ....................................................................................................................   │
    │ ....................................................................................................................   │
    ...
    └────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
    |}];
  (* Testing going full screen. *)
  Capytui_test.send_event handle (`Key (`ASCII 'f', []));
  Handle.recompute_view handle;
  Handle.show handle;
  [%expect
    {|
    ...
    │ .............................76d8d8197d979a5bcf15fa79c0f8003a17713c6c.jpg)(row 1)(column.............................. │
    │ ............................. 1)(dimensions((height 28)(width 118)))(scale true))..................................... │
    │ ...................................................................................................................... │
    │ ...................................................................................................................... │
    │ ...................................................................................................................... │
    │ ...................................................................................................................... │

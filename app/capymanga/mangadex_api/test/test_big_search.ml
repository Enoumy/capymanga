       ...
       ((id a1db428c-685c-4d11-927b-bf71eb4b254b)
        (attributes
         ((title (((language en) (string "Juuou to Yakusou"))))
          ...
          (is_locked false)
          (links
           ((((provider al) (link 173339))
             ((provider ap) (link juuou-to-yakusou))
         ...
         ((title (((language en) (string "Inochi no Tabekata"))))
          ...
          (links
           ((((provider al) (link 171127))
             ...
             ((provider raw)
              (link
               https://comic-walker.com/detail/KC_001766_S?episodeType=first)))))
          (original_language ja) (last_volume ("")) (last_chapter (""))
       ...
       ((id 2051ec2f-1b26-465e-acb5-5870ca535ba9)
        (attributes
         ((title (((language en) (string "Cigarette and Cherry"))))
          ...
          (is_locked false)
          (links
           ((((provider al) (link 102215))
             ((provider ap) (link cigarette-cherry))
         ...
         ((title (((language en) (string "Android Kikaider"))))
          ...
          (links
           ((((provider al) (link 34750)) ((provider ap) (link kikaider))
             ((provider bw) (link series/15555/list))
             ((provider kt) (link 10165)) ((provider mu) (link 49131))
             ((provider amz)
              (link
         ...
         ((title (((language en) (string "My Dearest Nemesis"))))
          ...
          (links
           ((((provider al) (link 162236)) ((provider ap) (link my-dear-enemy))
             ...
             ((provider raw)
              (link https://www.kuaikanmanhua.com/web/topic/17650)))))
         ...
         ((title (((language en) (string "I'm in Love with the Villainess"))))
          ...
          (links
           ((((provider al) (link 118695))
             ...
             ((provider raw)
              (link
               https://pocket.shonenmagazine.com/episode/3269754496819342400))
             ((provider engtl)
              (link
       ...
       ((id 90542072-664e-4e56-b5eb-d7dc5ebfda53)
        (attributes
         ((title (((language en) (string "Celeb Lady"))))
          ...
          (description ()) (is_locked false)
          (links
           ((((provider mu) (link 0rqetor)) ((provider mal) (link 172102)))))
          (original_language ko) (last_volume ("")) (last_chapter (""))
          (publication_demographic ()) (status ongoing) (year (2024))
          (content_rating safe)
          (tags
       ...
       ((id 4c2b7c0d-f97b-4044-b94a-638d99e92d24)
        (attributes
         ((title (((language en) (string "Hana Yori Dango: Boys Over Flowers"))))
          ...
          (is_locked false)
          (links
           ((((provider al) (link 30877))
             ((provider ap) (link boys-over-flowers)) ((provider kt) (link 1908))
             ((provider mu) (link 328))
             ((provider amz)
         ...
         ((title (((language en) (string Re:Monster))))
          ...
          (links
           ((((provider al) (link 85495)) ((provider ap) (link re-monster))
             ((provider bw) (link series/62182/list))
             ((provider kt) (link 25426)) ((provider mu) (link 109745))
             ((provider nu) (link remonster))
             ((provider amz)
         ...
         ((title
          ...
          (links
           ((((provider al) (link 150717))
             ...
             ((provider nu)
              (link i-the-sacrifice-somehow-killed-the-evil-god-ln))
       ...
       ((id f032b354-db45-4f39-a07e-1e4902c02c7a)
        (attributes
         ((title (((language en) (string "Kimi to Picopico"))))
          ...
          (is_locked false)
          (links
           ((((provider al) (link 131287))
             ((provider ap) (link kimi-to-picopico))
             ...
             ((provider raw)
              (link
               https://pocket.shonenmagazine.com/episode/3269632237290946280)))))
         ...
         ((title (((language en) (string "Cheeky Brat"))))
          ...
          (links
           ((((provider al) (link 85395)) ((provider ap) (link namaikizakari))
             ((provider bw) (link series/21572/list))
             ((provider kt) (link 25496)) ((provider mu) (link 104388))
             ((provider amz)
         ...
         ((title (((language en) (string "Battle Studies"))))
          ...
          (links
           ((((provider al) (link 95443)) ((provider ap) (link battle-studies))
             ((provider bw) (link series/43397/list))
             ((provider kt) (link 36282)) ((provider mu) (link 117245))
       ...
       ((id b64cdcc2-b4e9-48f7-b45e-7f6e80aabd3a)
        (attributes
         ((title (((language en) (string "Yowa Yowa Sensei"))))
          ...
          (is_locked false)
          (links
           ((((provider al) (link 157128))
             ((provider ap) (link yowa-yowa-sensei))
       ...
       ((id a0d05d57-4a2c-4d4b-9aa6-7b99bed425ca)
        (attributes
         ((title
          ...
          (links
           ((((provider engtl)
              (link https://www.pixiv.net/en/artworks/106218143)))))
          (original_language en) (last_volume ("")) (last_chapter (""))
          (publication_demographic ()) (status completed) (year (2023))
          (content_rating safe)
          (tags
       ...
       ((id b1d12720-49d7-4730-9945-1cd8737d97e4)
        (attributes
         ((title
          ...
          (links
           ((((provider engtl)
              (link https://www.pixiv.net/en/artworks/109460984)))))
          (original_language en) (last_volume ("")) (last_chapter (""))
          (publication_demographic ()) (status completed) (year (2023))
          (content_rating safe)
          (tags
       ...
       ((id 8d5d7c3b-eb95-4e58-838f-4da6c2cbee1f)
        (attributes
         ((title
          ...
          (is_locked false) (links (())) (original_language ja)
          (last_volume ("")) (last_chapter ("")) (publication_demographic ())
          (status completed) (year ()) (content_rating safe)
          (tags
           (((id 0234a31e-a729-4e28-9d6a-3f87c4966b9e)
             (attributes
              ((name (((language en) (string Oneshot)))) (group format)
         ...
         ((title (((language en) (string "Chimamire Sukeban Chainsaw"))))
          ...
          (links
           ((((provider al) (link 87407))
             ...
             ((provider cdj)
              (link http://www.cdjapan.co.jp/product/NEOBK-718398))
             ((provider ebj)
